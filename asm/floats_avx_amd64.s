...
LBB0_3:
    ...
    LONG $0x0258fcc5             // vaddps    ymm0, ymm0, yword [rdx]
    LONG $0x0211fcc5             // vmovups    yword [rdx], ymm0
    LONG $0x187de2c4; BYTE $0x06 // vbroadcastss    ymm0, dword [rsi]
    LONG $0x4759fcc5; BYTE $0x20 // vmulps    ymm0, ymm0, yword [rdi + 32]
    LONG $0x4258fcc5; BYTE $0x20 // vaddps    ymm0, ymm0, yword [rdx + 32]
...
LBB1_17:
    ...
    LONG $0x107aa1c4; WORD $0x8744; BYTE $0x08 // vmovss    xmm0, dword [rdi + 4*r8 + 8]
    LONG $0x0659fac5             // vmulss    xmm0, xmm0, dword [rsi]
    LONG $0x117aa1c4; WORD $0x8244; BYTE $0x08 // vmovss    dword [rdx + 4*r8 + 8], xmm0
    LONG $0x107aa1c4; WORD $0x8744; BYTE $0x0c // vmovss    xmm0, dword [rdi + 4*r8 + 12]
    LONG $0x0659fac5             // vmulss    xmm0, xmm0, dword [rsi]
...
LBB2_18:
    ...
    LONG $0x0411fac5; BYTE $0x8f // vmovss    dword [rdi + 4*rcx], xmm0
    LONG $0x0610fac5             // vmovss    xmm0, dword [rsi]
    LONG $0x4459fac5; WORD $0x048f // vmulss    xmm0, xmm0, dword [rdi + 4*rcx + 4]
    LONG $0x4411fac5; WORD $0x048f // vmovss    dword [rdi + 4*rcx + 4], xmm0
    LONG $0x0610fac5             // vmovss    xmm0, dword [rsi]
    LONG $0x4459fac5; WORD $0x088f // vmulss    xmm0, xmm0, dword [rdi + 4*rcx + 8]
    LONG $0x4411fac5; WORD $0x088f // vmovss    dword [rdi + 4*rcx + 8], xmm0
    LONG $0x0610fac5             // vmovss    xmm0, dword [rsi]
    LONG $0x4459fac5; WORD $0x0c8f // vmulss    xmm0, xmm0, dword [rdi + 4*rcx + 12]
...
LBB3_3:
    ...
    LONG $0x4659fcc5; BYTE $0x20 // vmulps    ymm0, ymm0, yword [rsi + 32]
    LONG $0x4211fcc5; BYTE $0x20 // vmovups    yword [rdx + 32], ymm0
    LONG $0x4710fcc5; BYTE $0x40 // vmovups    ymm0, yword [rdi + 64]
    LONG $0x4659fcc5; BYTE $0x40 // vmulps    ymm0, ymm0, yword [rsi + 64]
    LONG $0x4211fcc5; BYTE $0x40 // vmovups    yword [rdx + 64], ymm0
    LONG $0x4710fcc5; BYTE $0x60 // vmovups    ymm0, yword [rdi + 96]
    LONG $0x4659fcc5; BYTE $0x60 // vmulps    ymm0, ymm0, yword [rsi + 96]
...
LBB3_12:
    ...
    LONG $0x597ca1c4; WORD $0x9604 // vmulps    ymm0, ymm0, yword [rsi + 4*r10]
    LONG $0x5974a1c4; WORD $0x964c; BYTE $0x20 // vmulps    ymm1, ymm1, yword [rsi + 4*r10 + 32]
    LONG $0x596ca1c4; WORD $0x9654; BYTE $0x40 // vmulps    ymm2, ymm2, yword [rsi + 4*r10 + 64]
    LONG $0x5964a1c4; WORD $0x965c; BYTE $0x60 // vmulps    ymm3, ymm3, yword [rsi + 4*r10 + 96]
...
LBB3_15:
    LONG $0x107aa1c4; WORD $0x8704 // vmovss    xmm0, dword [rdi + 4*r8]
    LONG $0x597aa1c4; WORD $0x8604 // vmulss    xmm0, xmm0, dword [rsi + 4*r8]
    LONG $0x117aa1c4; WORD $0x8204 // vmovss    dword [rdx + 4*r8], xmm0
    WORD $0xff49; BYTE $0xc0     // inc    r8
    WORD $0xff48; BYTE $0xc9     // dec    rcx
	JNE LBB3_15
...
LBB3_17:
    ...
    LONG $0x117aa1c4; WORD $0x8204 // vmovss    dword [rdx + 4*r8], xmm0
    LONG $0x107aa1c4; WORD $0x8744; BYTE $0x04 // vmovss    xmm0, dword [rdi + 4*r8 + 4]
    LONG $0x597aa1c4; WORD $0x8644; BYTE $0x04 // vmulss    xmm0, xmm0, dword [rsi + 4*r8 + 4]
    LONG $0x117aa1c4; WORD $0x8244; BYTE $0x04 // vmovss    dword [rdx + 4*r8 + 4], xmm0
    LONG $0x107aa1c4; WORD $0x8744; BYTE $0x08 // vmovss    xmm0, dword [rdi + 4*r8 + 8]
    LONG $0x597aa1c4; WORD $0x8644; BYTE $0x08 // vmulss    xmm0, xmm0, dword [rsi + 4*r8 + 8]
    LONG $0x117aa1c4; WORD $0x8244; BYTE $0x08 // vmovss    dword [rdx + 4*r8 + 8], xmm0
    LONG $0x107aa1c4; WORD $0x8744; BYTE $0x0c // vmovss    xmm0, dword [rdi + 4*r8 + 12]
    LONG $0x597aa1c4; WORD $0x8644; BYTE $0x0c // vmulss    xmm0, xmm0, dword [rsi + 4*r8 + 12]
    LONG $0x117aa1c4; WORD $0x8244; BYTE $0x0c // vmovss    dword [rdx + 4*r8 + 12], xmm0
    LONG $0x04c08349             // add    r8, 4
    WORD $0x394c; BYTE $0xc0     // cmp    rax, r8
	JNE LBB3_17
...
LBB4_5:
    ...
    LONG $0x5710fcc5; BYTE $0x20 // vmovups    ymm2, yword [rdi + 32]
    LONG $0x5f10fcc5; BYTE $0x40 // vmovups    ymm3, yword [rdi + 64]
    LONG $0x6710fcc5; BYTE $0x60 // vmovups    ymm4, yword [rdi + 96]
    LONG $0x0e59f4c5             // vmulps    ymm1, ymm1, yword [rsi]
    LONG $0xc158fcc5             // vaddps    ymm0, ymm0, ymm1
    LONG $0x4e59ecc5; BYTE $0x20 // vmulps    ymm1, ymm2, yword [rsi + 32]
    LONG $0x5659e4c5; BYTE $0x40 // vmulps    ymm2, ymm3, yword [rsi + 64]
    LONG $0xc158fcc5             // vaddps    ymm0, ymm0, ymm1
    LONG $0xc258fcc5             // vaddps    ymm0, ymm0, ymm2
    LONG $0x4e59dcc5; BYTE $0x60 // vmulps    ymm1, ymm4, yword [rsi + 96]
    LONG $0xc158fcc5             // vaddps    ymm0, ymm0, ymm1
    LONG $0x80ef8348             // sub    rdi, -128
    LONG $0x80ee8348             // sub    rsi, -128
    LONG $0xfcc08341             // add    r8d, -4
...
LBB4_16:
    ...
    LONG $0x9979e2c4; WORD $0x860c // vfmadd132ss    xmm1, xmm0, dword [rsi + 4*rax]
    LONG $0x0911fac5             // vmovss    dword [rcx], xmm1
    LONG $0x4410fac5; WORD $0x0487 // vmovss    xmm0, dword [rdi + 4*rax + 4]
    LONG $0x9971e2c4; WORD $0x8644; BYTE $0x04 // vfmadd132ss    xmm0, xmm1, dword [rsi + 4*rax + 4]
    LONG $0x0111fac5             // vmovss    dword [rcx], xmm0
    LONG $0x4c10fac5; WORD $0x0887 // vmovss    xmm1, dword [rdi + 4*rax + 8]
    LONG $0x9979e2c4; WORD $0x864c; BYTE $0x08 // vfmadd132ss    xmm1, xmm0, dword [rsi + 4*rax + 8]
    LONG $0x0911fac5             // vmovss    dword [rcx], xmm1
    LONG $0x4410fac5; WORD $0x0c87 // vmovss    xmm0, dword [rdi + 4*rax + 12]
    LONG $0x9971e2c4; WORD $0x8644; BYTE $0x0c // vfmadd132ss    xmm0, xmm1, dword [rsi + 4*rax + 12]
    LONG $0x0111fac5             // vmovss    dword [rcx], xmm0
...
LBB4_13:
    ...
    LONG $0xb971e2c4; WORD $0xbe04 // vfmadd231ss    xmm0, xmm1, dword [rsi + 4*rdi]
    LONG $0x0111fac5             // vmovss    dword [rcx], xmm0
